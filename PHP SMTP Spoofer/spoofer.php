...
function floodc()
        {
            ...
            if(!fc)
            {
             alert("Disabling flood control almost guarantees detection and action by your ISP.\nOnly turn this off if you are SURE it's okay with your ISP to send the amount of e-mail you input plan to send.");
            }
        }
</script>
